      ...
      {!gameOver && score === 0 && lives === 3 && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/50">
          <div className="bg-background p-8 rounded-lg max-w-md text-center">
            <h1 className="text-4xl font-bold mb-4 text-game-player">Forest Zombie Survival</h1>
            <p className="mb-6 text-lg">
              Survive the zombie apocalypse in the forest! Move with WASD or arrow keys, and shoot with spacebar.
              Watch your ammo and collect refills from yellow boxes. How long can you last?
            </p>
            <Button 
              onClick={onStart}
